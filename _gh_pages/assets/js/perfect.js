/*!
 ...
 Copyright © 2016-2019 JD Finance Inc.
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isWheel", function() { return isWheel; });
...
/* harmony import */ var _base_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../base/component */ "./components/base/component.js");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./util */ "./components/elements/menu/list-menu/util.js");
...
function (_Component) {
  ...
  function ListMenu(_element, config) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ListMenu).call(this, _element, config)); // 是否过滤掉分隔符 list-divider，默认过滤

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleClickMenu", function (e) {
      var target = e.target;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleKeyboardUp", function (evt) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleKeyboardDown", function (evt) {
      // Do nothing if Alt, Ctrl or Meta are pressed.
      if (evt.altKey || evt.ctrlKey || evt.metaKey) {
        return true;
      }
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleDocumentClick", function (evt) {
      var el = evt.target;
      ...
      var expandedEl = _this.element.querySelectorAll(strings.EXPANDED);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleItemScroll", function (evt) {
      var step = 10;
      ...
      if (upDown === 'up' && y < 0) {
        _this.itemsContainer.style.transform = "translateY(".concat(Math.min(y + step, 0), "px)");
      } else if (upDown === 'down' && Math.abs(y) < _this.maxOffset) {
        _this.itemsContainer.style.transform = "translateY(".concat(Math.max(y - step, -_this.maxOffset), "px)");
      }
    });
  ...
  _createClass(ListMenu, [{
    ...
    value: function createAdapter() {
      ...
      return {
        ...
        setScale: function setScale(x, y) {
          _this2.element.style[Object(_util__WEBPACK_IMPORTED_MODULE_9__["getTransformPropertyName"])(win)] = "scale(".concat(x, ", ").concat(y, ")");
        },
        setInnerScale: function setInnerScale(x, y) {
          _this2.itemsContainer.style[Object(_util__WEBPACK_IMPORTED_MODULE_9__["getTransformPropertyName"])(win)] = "scale(".concat(x, ", ").concat(y, ")");
        },
        ...
        setActiveItemAtIndex: function setActiveItemAtIndex(index) {
          ...
          _this2.previousActiveItemsIndex.push(Object(_util__WEBPACK_IMPORTED_MODULE_9__["getElementIndexOfParent"])(_this2.leafItems[index], _this2.filterDivider));

          var parentNode = _this2.leafItems[index].parentNode.parentNode; // 分支节点也设置 ACTIVE
          ...
          while (parentNode && parentNode.classList.contains(classes.LIST_ITEM)) {
            ...
            _this2.previousActiveItemsIndex.unshift(Object(_util__WEBPACK_IMPORTED_MODULE_9__["getElementIndexOfParent"])(parentNode, _this2.filterDivider));
        ...
        setTransformOrigin: function setTransformOrigin(origin) {
          _this2.element.style["".concat(Object(_util__WEBPACK_IMPORTED_MODULE_9__["getTransformPropertyName"])(win), "-origin")] = origin;
        },
    ...
    value: function init() {
      ...
      this.itemsContainer = this.element.querySelector(ITEMS_SELECTOR); // 返回菜单第一层 items 中的所有 item

      this.items = [].slice.call(this.itemsContainer.querySelectorAll(LIST_ITEM_SELECTOR)); // 返回菜单 items 中的所有叶子节点item
    ...
    value: function render() {
      ...
      if (!this.adapter.hasClass(ELEMENT)) {
        throw new Error("\u5217\u8868\u83DC\u5355\u6839\u8282\u70B9\u9700\u8981\u8BBE\u7F6E class ".concat(ELEMENT, "."));
      }
    ...
    value: function calcItemHeight() {
      ...
      var paddingBottom = property.getPropertyValue('padding-bottom');
    ...
    value: function adjustMenuMaxHeight() {
      ...
      this.itemsContainer.style.setProperty('height', "".concat(this.visibleItemHeight, "px")); // 隐藏多余的 item
    ...
    value: function applyTransitionDelays() {
      ...
      for (var index = 0; index < numItems; index++) {
        var _this$adapter$getYPar = this.adapter.getYParamsForItemAtIndex(index),
        ...
        this.adapter.setTransitionDelayForItemAtIndex(index, "".concat(itemDelay.toFixed(3), "s"));
      }
    }
    /** @private */
    // 自动计算位置
    ...
    value: function autoPosition() {
      ...
      this.adapter.setTransformOrigin("".concat(vertical, " ").concat(horizontal));
    ...
    value: function animationLoop() {
      ...
      var currentTime = Object(_util__WEBPACK_IMPORTED_MODULE_9__["clamp"])((time - this.startTime) / TRANSITION_DURATION_MS); // Animate X axis very slowly, so that only the Y axis animation is visible during fade-out.

      var currentTimeX = Object(_util__WEBPACK_IMPORTED_MODULE_9__["clamp"])((currentTime - TRANSITION_SCALE_ADJUSTMENT_X) / (1 - TRANSITION_SCALE_ADJUSTMENT_X)); // No time-shifting on the Y axis when closing.
      ...
      if (this.targetScale === 1) {
        ...
        currentTimeX = Object(_util__WEBPACK_IMPORTED_MODULE_9__["clamp"])(currentTime + TRANSITION_SCALE_ADJUSTMENT_X); // Y axis moves slower, so time-shift backwards and adjust speed by the difference.

        currentTimeY = Object(_util__WEBPACK_IMPORTED_MODULE_9__["clamp"])((currentTime - TRANSITION_SCALE_ADJUSTMENT_Y) / (1 - TRANSITION_SCALE_ADJUSTMENT_Y));
      } // 为 X 和 Y 轴方向设置贝塞尔曲线


      var easeX = Object(_util__WEBPACK_IMPORTED_MODULE_9__["bezierProgress"])(currentTimeX, TRANSITION_X1, TRANSITION_Y1, TRANSITION_X2, TRANSITION_Y2);
      var easeY = Object(_util__WEBPACK_IMPORTED_MODULE_9__["bezierProgress"])(currentTimeY, TRANSITION_X1, TRANSITION_Y1, TRANSITION_X2, TRANSITION_Y2); // Calculate the scales to apply to the outer container and inner container.
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getElementIndexOfParent", function() { return getElementIndexOfParent; });
...
/* harmony import */ var core_js_modules_es6_object_define_property__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! core-js/modules/es6.object.define-property */ "./node_modules/core-js/modules/es6.object.define-property.js");
...
/* harmony import */ var core_js_modules_es6_object_create__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! core-js/modules/es6.object.create */ "./node_modules/core-js/modules/es6.object.create.js");
...
/* harmony import */ var core_js_modules_es6_object_set_prototype_of__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! core-js/modules/es6.object.set-prototype-of */ "./node_modules/core-js/modules/es6.object.set-prototype-of.js");
...
/* harmony import */ var core_js_modules_es6_number_is_nan__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! core-js/modules/es6.number.is-nan */ "./node_modules/core-js/modules/es6.number.is-nan.js");
/* harmony import */ var core_js_modules_es6_number_is_nan__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_number_is_nan__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _base_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../base/component */ "./components/base/component.js");
...
function (_Component) {
  ...
  function Paging(element, config) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Paging).call(this, element, _objectSpread({}, Paging.defaultConfig, config))); // 当前页，从1开始，默认1

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSwitchPage", function (evt) {
      evt.preventDefault();
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleChangePerPage", function (evt) {
      evt.preventDefault();
      var target = evt.target;
      var classList = target.classList;
  ...
  _createClass(Paging, [{
    ...
    value: function renderPaging() {
      ...
      html += "<li class=\"paging-item".concat(this.pageNum === 1 ? " ".concat(classes.DISABLED) : '', "\" data-pagenum=\"").concat(this.pageNum - 1, "\">\u4E0A\u4E00\u9875</li>");
      var pageItems = pageArray.map(function (item, index) {
        if (item === '...') {
          return '<li class="paging-item paging-more"></li>';
        }

        return "<li class=\"paging-item".concat(_this3.pageNum === item ? " ".concat(classes.ACTIVE) : '', "\" data-pagenum=\"").concat(item, "\">").concat(item, "</li>");
      });
      html += pageItems.join('');
      html += "<li class=\"paging-item".concat(this.pageNum === this.totalPages ? " ".concat(classes.DISABLED) : '', "\" data-pagenum=\"").concat(this.pageNum + 1, "\">\u4E0B\u4E00\u9875</li>");
      html += '</ul>';
    ...
    value: function renderPagingControl() {
      ...
      html += "<li class=\"paging-control-item\">\u5171".concat(this.totalPages, "\u9875").concat(this.totalCount || 0, "\u6761\u8BB0\u5F55,</li>");
      /* eslint-disable prettier/prettier, indent */

      if (this.recordPerPage) {
        html += "<li class=\"paging-control-item\">\n        \u6BCF\u9875\n        <div class=\"select\">\n        <select class=\"select-inner\">\n          <option value=\"5\"".concat(this.pageSize === 5 ? ' selected' : '', ">5</option>\n          <option value=\"10\"").concat(this.pageSize === 10 ? ' selected' : '', ">10</option>\n          <option value=\"20\"").concat(this.pageSize === 20 ? ' selected' : '', ">20</option>\n          <option value=\"50\"").concat(this.pageSize === 50 ? ' selected' : '', ">50</option>\n          <option value=\"100\"").concat(this.pageSize === 100 ? ' selected' : '', ">100</option>\n        </select>\n        </div>\n      \u6761,\n    </li>");
      }
...
/* harmony import */ var core_js_modules_es6_array_index_of__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_array_index_of__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _base_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../base/component */ "./components/base/component.js");
/* harmony import */ var _elements_menu_list_menu_list_menu__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../elements/menu/list-menu/list-menu */ "./components/elements/menu/list-menu/list-menu.js");
...
function (_Component) {
  ...
  function Select(element, config) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Select).call(this, element, config)); // 创建适配器

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "displayHandler", function (evt) {
      evt.preventDefault();
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "selectionHandler", function (_ref) {
  ...
  _createClass(Select, [{
    ...
    value: function init() {
      var menuFactory = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function (el) {
        return new _elements_menu_list_menu_list_menu__WEBPACK_IMPORTED_MODULE_9__["default"](el);
      };
    ...
    value: function addEventListeners() {
      ...
      this.selectInner.addEventListener('keyup', this.handleDisplayKeyboard); // 监听 ListMenu 事件

      this.menu.listen(_elements_menu_list_menu_list_menu__WEBPACK_IMPORTED_MODULE_9__["default"].strings.SELECTED_EVENT, this.selectionHandler);
      this.menu.listen(_elements_menu_list_menu_list_menu__WEBPACK_IMPORTED_MODULE_9__["default"].strings.CANCEL_EVENT, this.cancelHandler);
    } // 删除事件
    ...
    value: function removeEventListeners() {
      ...
      this.selectInner.removeEventListener('keyup', this.handleDisplayKeyboard); // 监听 ListMenu 事件

      this.menu.unlisten(_elements_menu_list_menu_list_menu__WEBPACK_IMPORTED_MODULE_9__["default"].strings.SELECTED_EVENT, this.selectionHandler);
      this.menu.unlisten(_elements_menu_list_menu_list_menu__WEBPACK_IMPORTED_MODULE_9__["default"].strings.CANCEL_EVENT, this.cancelHandler);
    }
  }, {
    key: "item",
    ...
    value: function setMenuStylesForOpen(selectedRootOption) {
      ...
      var overflowsBottom = adjustedTop + menuHeight > winInnerHeight;
      ...
      this.adapter.setMenuElStyle('top', "".concat(adjustedTop, "px"));
      this.adapter.setMenuElStyle('transform-origin', "center ".concat(itemOffsetTop, "px"));
    }
  }, {
    key: "nameditem",
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _scroll_spy_scrollSpy__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scroll-spy/scrollSpy */ "./components/scroll-spy/scrollSpy.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ScrollSpy", function() { return _scroll_spy_scrollSpy__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var _scroll_spy_plugins_catalogueSpy__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scroll-spy/plugins/catalogueSpy */ "./components/scroll-spy/plugins/catalogueSpy.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CatalogueSpy", function() { return _scroll_spy_plugins_catalogueSpy__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _ripple_ripple__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ripple/ripple */ "./components/ripple/ripple.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Ripple", function() { return _ripple_ripple__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _elements_menu_list_menu_list_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./elements/menu/list-menu/list-menu */ "./components/elements/menu/list-menu/list-menu.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ListMenu", function() { return _elements_menu_list_menu_list_menu__WEBPACK_IMPORTED_MODULE_3__["default"]; });

/* harmony import */ var _forms_select_select__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./forms/select/select */ "./components/forms/select/select.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Select", function() { return _forms_select_select__WEBPACK_IMPORTED_MODULE_4__["default"]; });

/* harmony import */ var _elements_paging_paging__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./elements/paging/paging */ "./components/elements/paging/paging.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Paging", function() { return _elements_paging_paging__WEBPACK_IMPORTED_MODULE_5__["default"]; });
...
/* harmony import */ var core_js_modules_es6_date_now__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! core-js/modules/es6.date.now */ "./node_modules/core-js/modules/es6.date.now.js");
/* harmony import */ var core_js_modules_es6_date_now__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_date_now__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony import */ var _base_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../base/component */ "./components/base/component.js");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./util */ "./components/ripple/util.js");
...
function (_Component) {
  ...
  _createClass(Ripple, null, [{
    ...
    value: function mount(element) {
      var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
          ...
          unbounded = _ref$unbounded === void 0 ? undefined : _ref$unbounded;
    ...
    value: function createAdapter(instance) {
      var matches = Object(_util__WEBPACK_IMPORTED_MODULE_12__["getMatchesProperty"])(HTMLElement.prototype); // 封装一些适配器方法

      return {
        isSupportsCssVars: function isSupportsCssVars() {
          return Object(_util__WEBPACK_IMPORTED_MODULE_12__["supportsCssVariables"])();
        },
        ...
        registerImpactHandler: function registerImpactHandler(evtType, handler) {
          return instance.element.addEventListener(evtType, handler, Object(_util__WEBPACK_IMPORTED_MODULE_12__["applyPassive"])());
        },
        deregisterImpactHandler: function deregisterImpactHandler(evtType, handler) {
          return instance.element.removeEventListener(evtType, handler, Object(_util__WEBPACK_IMPORTED_MODULE_12__["applyPassive"])());
        },
  ...
  function Ripple(element, config) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Ripple).call(this, element, config)); // 用来处理是否设置了 disabled
    ...
    _this.adapter = Ripple.createAdapter(_assertThisInitialized(_assertThisInitialized(_this))); // 用来处理 requestAnimationFrame 返回的值
  ...
  _createClass(Ripple, [{
    ...
    value: function layoutInternal() {
      ...
      var diameter = Math.sqrt(Math.pow(width, 2) + Math.pow(height, 2)); // 初始波纹大小，取元素大小的 60%
    ...
    value: function updateCssVariableValue() {
      ...
      this.adapter.updateCssVariable(VAR_SIZE, "".concat(this.initialSize, "px"));
      ...
      if (this.adapter.isUnbounded()) {
        ...
        this.adapter.updateCssVariable(VAR_LEFT, "".concat(this.unboundedCoords.left, "px"));
        this.adapter.updateCssVariable(VAR_TOP, "".concat(this.unboundedCoords.top, "px"));
      }
    } // 设置监听事件
    ...
    value: function animateActivation() {
      ...
      this.adapter.updateCssVariable(VAR_TRANSLATE_END, translateEnd); // 取消进行中的 activation 和 deactivation
    ...
    value: function getTranslationCoords() {
      ...
      if (wasActivatedByPointer) {
        startPoint = Object(_util__WEBPACK_IMPORTED_MODULE_12__["getNormalizedEventCoords"])(activationEvent, this.adapter.getWindowPageOffset(), this.adapter.computeBoundingRect());
      } else {
        startPoint = {
          x: width / 2,
          y: height / 2
    ...
    value: function runDeactivationAnimation() {
      ...
      var _this$activationState = this.activationState,
          hasDeactivationUXRun = _this$activationState.hasDeactivationUXRun,
...
function supportsCssVariables() {
  ...
  var supportsFunctionPresent = win.CSS && typeof win.CSS.supports === 'function';

  if (!supportsFunctionPresent) {
    return;
  }

  var explicitlySupportsCssVars = win.CSS.supports('--css-vars', 'yes');
  /*
   * See: https://bugs.webkit.org/show_bug.cgi?id=154669
   * See: README section on Safari
   */

  var weAreFeatureDetectingSafari10plus = win.CSS.supports('(--css-vars: yes)') && win.CSS.supports('color', '#00000000');
...
/* harmony import */ var _base_util__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../base/util */ "./components/base/util.js");
...
var isWheel = _base_util__WEBPACK_IMPORTED_MODULE_6__["default"].isWheel;
var win = window;
var doc = document;
...
function () {
  function CatalogueSpy(scrollSpy) {
    ...
    _defineProperty(this, "adjustMenuHeight", function () {
      ...
      _this.$menuPanel.style.maxHeight = "".concat(menuHeight, "px");
    });
    ...
    _defineProperty(this, "handleScroll", function (prevent) {
      return (
        ...
        function (e) {
          ...
          if (upDown === 'up' && y < 0) {
            _this.$menuPanel.style.transform = "translateY(".concat(Math.min(y + step, 0), "px)");
          } else if (upDown === 'down' && Math.abs(y) < _this.maxOffset) {
            _this.$menuPanel.style.transform = "translateY(".concat(Math.max(y - step, -_this.maxOffset), "px)");
          }
        }
      );
    });
        ...
        Array.prototype.forEach.call(currentTarget, function (el) {
          ...
          while (rect.top > 0 && rect.bottom > 0 && (rect.top < menuRect.top || rect.bottom > menuRect.bottom)) {
            ...
            if (rect.top < menuRect.top) {
              $menuPanel.style.transform = "translateY(".concat(Math.min(y + step, 0), "px)");
            } else {
              $menuPanel.style.transform = "translateY(".concat(Math.max(y - step, -maxOffset), "px)");
            }
    ...
    this.config = _objectSpread({}, CatalogueSpy.defaultConfig, config);
...
/* harmony default export */ __webpack_exports__["default"] = (CatalogueSpy);
...
/* harmony import */ var core_js_modules_es6_string_anchor__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! core-js/modules/es6.string.anchor */ "./node_modules/core-js/modules/es6.string.anchor.js");
/* harmony import */ var core_js_modules_es6_string_anchor__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_string_anchor__WEBPACK_IMPORTED_MODULE_7__);
...
/* harmony import */ var core_js_modules_es6_array_for_each__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! core-js/modules/es6.array.for-each */ "./node_modules/core-js/modules/es6.array.for-each.js");
/* harmony import */ var core_js_modules_es6_array_for_each__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_array_for_each__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _base_util__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../base/util */ "./components/base/util.js");
...
function () {
  function ScrollSpy(element) {
    ...
    this.menuSelector = "".concat(menu, " .").concat(menuClsPrefix, "-title");
    this.offsets = [];
    this.targets = [];
    ...
    this.scrollElement.addEventListener(_base_util__WEBPACK_IMPORTED_MODULE_11__["isWheel"] ? 'mousewheel' : 'DOMMouseScroll', this.scrollEvent, false);
    ...
    this.menuPanel = "".concat(menu, " .").concat(menuClsPrefix, ".").concat(menuClsPrefix, "-catalogue");
    ...
    if (anchor === false) {
      ...
      forEach.call(menuElements, function (el) {
        el.addEventListener('click', function (e) {
          ...
          var targetEl = doc.querySelector("".concat(container, " [data-target=\"").concat(target.dataset, "\"]")).parentNode;
          var top = offsetMethod === 'offset' ? Object(_base_util__WEBPACK_IMPORTED_MODULE_11__["offset"])(targetEl).top : Object(_base_util__WEBPACK_IMPORTED_MODULE_11__["position"])(targetEl).top;
          var offsetBase = offsetMethod === 'position' ? _this.getScrollTop() : 0; // fixme
  ...
  _createClass(ScrollSpy, [{
    ...
    value: function getConfig(config) {
      var _config = _objectSpread({}, ScrollSpy.defaultConfig, config);
      ...
      if (typeof menu !== 'string') {
        ...
        if (!id) {
          id = Object(_base_util__WEBPACK_IMPORTED_MODULE_11__["getUuid"])('scrollspy');
          menu.id = id;
        }
      ...
      if (typeof container !== 'string') {
        ...
        if (!_id) {
          _id = Object(_base_util__WEBPACK_IMPORTED_MODULE_11__["getUuid"])('scrollspy');
          container.id = _id;
        }
    ...
    value: function generateMenus() {
      var menus = this.element.querySelectorAll('h1,h2,h3,h4,h5,h6'); // 初始化根节点
    ...
    value: function generateMenusHtml(nodes, prefix) {
      ...
      if (nodes && nodes.length > 0) {
        html = "<ul class=\"".concat(menuClsPrefix, " ").concat(menuClsPrefix, "-catalogue").concat(menuCls ? " ".concat(menuCls) : '', "\">");
        ...
        for (var i = 0, len = nodes.length; i < len; i++) {
          ...
          newChild.className = "".concat(menuClsPrefix, "-anchor");
          ...
          if (this.config.anchor) {
            html += "<a class=\"".concat(menuClsPrefix, "-title\" href=\"#").concat(prefix).concat(i + 1, "\">").concat(node.text, "</a>");
          } else {
            // 用 data-target 来控制，需要结合 js 来控制
            html += "<a class=\"".concat(menuClsPrefix, "-title\" data-target=\"").concat(prefix).concat(i + 1, "\" href=\"#\">").concat(node.text, "</a>");
          }

          if (node.children && node.children.length > 0) {
            html += this.generateMenusHtml(node.children, "".concat(prefix).concat(i + 1, "-"));
          }
    ...
    value: function refresh() {
      ...
      map.call(menuElements, function (element) {
        ...
        var targetSelector = anchor ? element.getAttribute('href') : "".concat(container, " [data-target=\"").concat(element.dataset.menu, "\"]");
        ...
        if (targetSelector) {
          ...
          if (targetBCR.width || targetBCR.height) {
            return [(offsetMethod === 'offset' ? Object(_base_util__WEBPACK_IMPORTED_MODULE_11__["offset"])(target).top : Object(_base_util__WEBPACK_IMPORTED_MODULE_11__["position"])(target).top) + offsetBase, selector];
          }
        }
    ...
    value: function process() {
      ...
      var maxScroll = this.config.offset + scrollHeight - this.getOffsetHeight(); // 不相等的话，重新刷新，比如改变页面窗口后
      ...
      queries = queries.map(function (query) {
        ...
        parentEls.forEach(function (item, index) {
          if (index === 0) {
            ...
            catalog += "-".concat(item);
            selector.push(anchor ? "".concat(query, "[href=\"").concat(catalog, "\"]") : "".concat(query, "[data-menu=\"").concat(catalog, "\"]"));
          }
        });
    ...
    value: function clearActiveCls() {
      // 删除当前活动样式
      var activeEls = doc.querySelectorAll("".concat(this.menuSelector, ".active"));
    ...
    value: function unmount() {
      ...
      this.scrollElement.removeEventListener(_base_util__WEBPACK_IMPORTED_MODULE_11__["isWheel"] ? 'mousewheel' : 'DOMMouseScroll', this.scrollEvent, false);
      this.element = null;
