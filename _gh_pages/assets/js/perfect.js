...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  \*********************************************************/
        ...
        /***/ function(module, __webpack_exports__, __webpack_require__) {
          'use strict';
          __webpack_require__.r(__webpack_exports__);
          /* harmony import */ var _base_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          ...
          var ListMenu = (function(_Component) {
            ...
            function ListMenu(element, config) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (ListMenu.__proto__ || Object.getPrototypeOf(ListMenu)).call(
                  this,
                  element,
                  config
                )
              ...
              _this.handleDocumentClick = function(evt) {
                ...
                [].forEach.call(expandedEl, function(el) {
              ...
              _this.handleItemScroll = function(evt) {
                var step = 10;
                ...
                if (upDown === 'up' && y < 0) {
                  _this.itemsContainer.style.transform =
                    'translateY(' + Math.min(y + step, 0) + 'px)';
            ...
            _createClass(ListMenu, [
                ...
                value: function createAdapter() {
                  ...
                  return {
                    ...
                    setActiveItemAtIndex: function setActiveItemAtIndex(index) {
                      ...
                      var parentNode =
                        _this2.leafItems[index].parentNode.parentNode;
                    ...
                    notifySelected: function notifySelected() {
                      _this2.emit(strings.SELECTED_EVENT, {
                        ...
                        leafIndex: _this2.activeItemIndex, // 叶子节点活动的 id
              ...
              },
              {
                ...
                value: function adjustMenuMaxHeight() {
                  ...
                  var _adapter$getWindowDim = this.adapter.getWindowDimensions(),
                    height = _adapter$getWindowDim.height;
              ...
              },
              {
                ...
                value: function applyTransitionDelays() {
                  ...
                  for (var index = 0; index < numItems; index++) {
                    var _adapter$getYParamsFo = this.adapter.getYParamsForItemAtIndex(
                        index
                      ),
              ...
              },
              {
                ...
                value: function animationLoop() {
                  ...
                  var currentTime = Object(
                    _util__WEBPACK_IMPORTED_MODULE_1__['clamp']
                  )((time - this.startTime) / TRANSITION_DURATION_MS);
                  ...
                  // 为 X 和 Y 轴方向设置贝塞尔曲线
                  var easeX = Object(
                    _util__WEBPACK_IMPORTED_MODULE_1__['bezierProgress']
                  )(
                    currentTimeX,
                    TRANSITION_X1,
                    TRANSITION_Y1,
        ...
        /***/ function(module, __webpack_exports__, __webpack_require__) {
          ...
          var Paging = (function(_Component) {
            ...
            function Paging(element, config) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (Paging.__proto__ || Object.getPrototypeOf(Paging)).call(
                  this,
                  element,
                  _extends({}, Paging.defaultConfig, config)
                )
              );
            ...
            _createClass(Paging, [
              ...
              },
              {
                ...
                value: function renderPaging() {
                  ...
                  var pageItems = pageArray.map(function(item, index) {
                    ...
                    return (
                      '<li class="paging-item' +
                      (_this3.pageNum === item ? ' ' + classes.ACTIVE : '') +
                      '" data-pagenum="' +
                      item +
                      '">' +
                      item +
              ...
              },
              {
                ...
                value: function renderPagingControl() {
                  ...
                  html +=
                    '<li class="paging-control-item">\u5171' +
                    this.totalPages +
                    '\u9875' +
                    (this.totalCount || 0) +
                    '\u6761\u8BB0\u5F55,</li>';
  ...
  \*******************************************/
        ...
        /***/ function(module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony import */ var _elements_menu_list_menu_list_menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
            ...
            _createClass(Select, [
                ...
                value: function init() {
                  var menuFactory =
                    arguments.length > 0 && arguments[0] !== undefined
                      ? arguments[0]
                      : function(el) {
                          return new _elements_menu_list_menu_list_menu__WEBPACK_IMPORTED_MODULE_1__[
                            'default'
                          ](el);
                        };
              ...
              },
              {
                ...
                value: function addEventListeners() {
                  ...
                  // 监听 ListMenu 事件
                  this.menu.listen(
                    _elements_menu_list_menu_list_menu__WEBPACK_IMPORTED_MODULE_1__[
                      'default'
        ...
        /***/ function(module, __webpack_exports__, __webpack_require__) {
          ...
          var Ripple = (function(_Component) {
            ...
            _createClass(Ripple, null, [
              {
                ...
                value: function mount(element) {
                  var _ref =
                    ...
                    unbounded =
                      _ref$unbounded === undefined ? undefined : _ref$unbounded;
              ...
              },
              {
                ...
                value: function createAdapter(instance) {
                  var matches = Object(
                    _util__WEBPACK_IMPORTED_MODULE_1__['getMatchesProperty']
                  ...
                  return {
                    ...
                    registerImpactHandler: function registerImpactHandler(
                      ...
                      return instance.element.addEventListener(
                        ...
                        handler,
                        Object(
                          _util__WEBPACK_IMPORTED_MODULE_1__['applyPassive']
                        )()
                      );
                    },
            ...
            function Ripple(element, config) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (Ripple.__proto__ || Object.getPrototypeOf(Ripple)).call(
                  this,
                  element,
                  config
                )
                ...
                value: function runDeactivationAnimation() {
                  ...
                  var _activationState = this.activationState,
                    hasDeactivationUXRun =
                      _activationState.hasDeactivationUXRun,
  ...
  \*******************************************************/
        ...
        /***/ function(module, __webpack_exports__, __webpack_require__) {
          'use strict';
          __webpack_require__.r(__webpack_exports__);
          /* harmony import */ var _base_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          ...
          var isWheel =
            _base_util__WEBPACK_IMPORTED_MODULE_0__['default'].isWheel;
          ...
          var _initialiseProps = function _initialiseProps() {
            ...
            this.handleScroll = function(prevent) {
              ...
              return function(event) {
                ...
                if (upDown === 'up' && y < 0) {
                  _this.$menuPanel.style.transform =
                    'translateY(' + Math.min(y + step, 0) + 'px)';
                } else if (upDown === 'down' && Math.abs(y) < _this.maxOffset) {
                  _this.$menuPanel.style.transform =
                    'translateY(' +
                ...
                Array.prototype.forEach.call(currentTarget, function(el) {
                  ...
                  while (
                    ...
                    if (rect.top < menuRect.top) {
                      ...
                      $menuPanel.style.transform =
                        'translateY(' + Math.max(y - step, -maxOffset) + 'px)';
                    }
          ...
          var ScrollSpy = (function() {
            function ScrollSpy(element) {
              ...
              this.scrollElement.addEventListener(
                _base_util__WEBPACK_IMPORTED_MODULE_0__['isWheel']
                  ? 'mousewheel'
                  : 'DOMMouseScroll',
                this.scrollEvent,
                false
                  ...
                  element.addEventListener(
                    ...
                    function(e) {
                      ...
                      var targetEl = doc.querySelector(
                        container + ' [data-target="' + menu + '"]'
                      ).parentNode;
                      var top =
                        offsetMethod === 'offset'
                          ? Object(
                              _base_util__WEBPACK_IMPORTED_MODULE_0__['offset']
                            )(targetEl).top
                          : Object(
                              _base_util__WEBPACK_IMPORTED_MODULE_0__[
                                'position'
                              ]
                            )(targetEl).top;
                      var offsetBase =
                        offsetMethod === 'position' ? _this.getScrollTop() : 0;
            ...
            _createClass(ScrollSpy, [
              {
                ...
                value: function getConfig(config) {
                  ...
                  if (typeof menu !== 'string') {
                    ...
                    if (!id) {
                      id = Object(
                        _base_util__WEBPACK_IMPORTED_MODULE_0__['getUuid']
                      )('scrollspy');
                      menu.id = id;
                    }
                    _config.menu = '#' + id;
